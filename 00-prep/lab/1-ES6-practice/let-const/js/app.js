...
function displayPics(){
  ...
  // It has to do with block scoping, where var is always global let is only scoped in the block that it was set in so it was unable to get that value outside of the block
  // once we declared rando outside the function as a global varible it then worked. 
  console.log(viewed);
